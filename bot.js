...
const CONFIG = {
    ...
    botUsername: 'Tgreportingban_bot',
...
const UserSchema = new mongoose.Schema({
    ...
    referral_claimed: { type: Boolean, default: false },
    ...
    pending_referrer: { type: String, default: null }
}, { timestamps: true });
                        ...
                        if (referrer) {
                            ...
                            if (!isReferrerAdmin) {
                                ...
                                if (!subCheck.allSubscribed) {
                                    addLog(`⚠️ Referrer ${referrer.username} not subscribed`, 'WARN');
